...
### This is a selection of functions from YOLOv7 (branch: u6) required to compute the loss from the outputs of a YOLOv7 model ###
# Modified slightly for compatibility/ simplicity
